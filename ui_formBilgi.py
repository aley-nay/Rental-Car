...
class Ui_Bilgi(object):
    def setupUi(self, Form):
        ...
        Form.resize(641, 411)
        Form.setStyleSheet(u"background-color: rgb(93, 93, 93);background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FFDAB9, stop:1 #FFA07A);\n"
"color: #FF8A65;\n"
"font-weight:800;\n"
"font-size:14px;")
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"Kiralama Paneli ฅ^•ﻌ•^ฅ", None))
